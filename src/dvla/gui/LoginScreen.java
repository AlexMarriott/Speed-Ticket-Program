     ...
     */
     /*   private JLabel lblPicture;
        ...
        public void loadButtons() {
            ...
            btnAddDriver.addActionListener(new dvla.gui.SpeedingTicketGUI.AddDriverHandler());
            pnlMainMenu.add(btnAddDriver);

            btnViewDriver = new JButton("View Driver");
            btnViewDriver.setBounds(120, 240, 140, 40);
            btnViewDriver.addActionListener(new dvla.gui.SpeedingTicketGUI.ViewDriverHandler());
            pnlMainMenu.add(btnViewDriver);

            btnIssueTicket = new JButton("Remove Driver");
            btnIssueTicket.setBounds(270, 240, 120, 40);
            btnIssueTicket.addActionListener(new dvla.gui.SpeedingTicketGUI.RemoveDriverHandler());
            pnlMainMenu.add(btnIssueTicket);

            btnExit = new JButton("Exit");
            btnExit.setBounds(140, 290, 100, 20);
            btnExit.addActionListener(new dvla.gui.SpeedingTicketGUI.ExitSplashHandler());
        ...
        public static void main(String[] args) throws IOException {
            ...
            new dvla.gui.SpeedingTicketGUI();
        }
    }
